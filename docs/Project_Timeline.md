...
- Pilot: completed on **28 August 2026**; v1.1 established the two-level architecture. The 31 August session led to v1.2. The 1 September session then exposed the post-MAX interpretation, stopping-rule and governance clarifications controlled in v1.3 from 2 September; live fields and timing rules remain comparable.
- Official baseline observations began **31 August 2026**. The current planning minimum is meaningful coverage on **five distinct working days**, followed by the v1.3 Day-5 coverage review. The two completed partial days contribute evidence but are not silently treated as two full-day equivalents. Five days is not automatically 40 net observed hours; both days/windows and net minutes are reported.
...
gantt
    ...
    Protocol v1.3 governance/logic freeze       :done, m2d, 2026-09-02, 1d
    ...
    Start-BEP professional-skill reflections :crit, ad2b, 2026-09-07, 10d
    Plan of Work draft to supervisor         :milestone, crit, ad3, 2026-09-20, 0d
    Complete scientific-conduct declaration  :ad3b, 2026-09-21, 1d
    ...
    Define workload endpoint + quality guardrail:crit, i1b, after i1, 3d
    Evaluation protocol freeze               :milestone, crit, i1c, after i1b, 0d
    Artifact / TO-BE design                  :crit, i2, after i1c, 7d
...
- whether the Day-5 coverage review requires targeted extension beyond the five-day planning minimum;
