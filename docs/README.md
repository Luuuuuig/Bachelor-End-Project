...
| Methodology / case selection | `methodology/Phase_1_Current_Methodology.md` | Current DMAIC/DSRM structure, workload logic and active/deprioritized case status |
...
4. update the company-document register if new formal documentation is received;
5. remove resolved items from **active** open-question lists rather than leaving them duplicated as unresolved.
