...
- [Measurement Protocol v1.2](Measurement_Protocol_v1.2.md) — protocol used for the 1 September session; retained for traceability and comparability.
- [Measure Live Cheat Sheet v1.2](Measure_Live_Cheat_Sheet_v1.2.md) — observer guide paired with v1.2.
